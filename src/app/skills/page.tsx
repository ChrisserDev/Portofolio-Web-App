...
export default function SkillsPage() {
  return (
    <main className='skills-page-container'>
      ...
      <ul>
        <li>
          <Image src={'/skills_logos/html_logo.png'} alt='HTML Logo' width={70} height={70} title='HTML — markup language for web pages' />
          <p>HTML</p>
        </li>
        <li>
          <Image src={'/skills_logos/css_logo.png'} alt='CSS Logo' width={70} height={70} title='CSS — styles and layout for the web' />
          <p>CSS</p>
        </li>
        <li>
          <Image src={'/skills_logos/sass_logo.png'} alt='Sass Logo' width={90} height={70} title='Sass — CSS preprocessor with variables & mixins' />
          <p>Sass</p>
        </li>
        <li>
        ...
        <li>
          <Image src={'/skills_logos/handlebars_logo.png'} alt='Handlebars Logo' width={70} height={70} title='Handlebars — templating engine for HTML' />
          <p>Handlebars</p>
        </li>
        <li>
        ...
        <li>
          <Image src={'/skills_logos/postman_logo.png'} alt='Postman Logo' width={80} height={70} title='Postman — API client for testing and docs' />
          <p>Postman</p>
        </li>
        <li>
        ...
        <li>
          <Image src={'/skills_logos/figma_logo.png'} alt='Figma Logo' width={80} height={70} title='Figma — collaborative UI design tool' />
          <p>Figma</p>
        </li>
        <li>
          <Image src={'/skills_logos/adobe_xd.png'} alt='Adobe XD Logo' width={70} height={70} title='Adobe XD — UI/UX design and prototyping' />
          <p>Adobe XD</p>
        </li>
        <li>
        ...
        <li>
          <Image src={'/skills_logos/github_logo.png'} alt='GitHub Logo' width={65} height={70} title='GitHub — Git hosting and collaboration' />
          <p>GitHub</p>
        </li>
        <li>
        ...
        <li>
          <Image src={'/skills_logos/webpack_logo.png'} alt='Webpack Logo' width={70} height={70} title='Webpack — JavaScript module bundler' />
          <p>Webpack</p>
        </li>
      </ul>
    </main>
