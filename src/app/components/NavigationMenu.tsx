  ...
  return (
    <nav className='navigation-menu'>
      ...
      <ul className='social-links'>
        ...
        <li>
          <a href='#' aria-label='GitHub' role='link' tabIndex={0} target="_blank" rel="noopener noreferrer">
        ...
        <li>
          <a href='#' aria-label='LinkedIn' role='link' tabIndex={0} target="_blank" rel="noopener noreferrer">
