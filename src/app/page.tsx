    ...
    <main className='home-page-container'>
      <div className='home-page-content'>
        <div className='home-page-title'>
          ...
          <a className='resume-link' href="https://drive.google.com/file/d/17SeumPNNR-ao5ywg09LNKy6lwUqA83uo/view?usp=sharing" target='_blank' rel="noopener noreferrer" aria-label='Link to Cristian Resume.'>Resume</a>
        </div>
