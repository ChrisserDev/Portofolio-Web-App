    ...
    <main className='home-page-container'>
      <div className='home-page-content'>
        <div className='home-page-title'>
          ...
          <a className='resume-link' href="https://drive.google.com/file/d/1NXF98dmaDa5GanQJ6JeChBGcYCOdxy_L/view?usp=sharing" target='_blank' rel="noopener noreferrer" aria-label='Link to Cristian Resume.'>Resume</a>
        </div>
